...
Point set_x(double x_new){
    return Point (x_new,y);
}
Point set_y(double y_new){
    return Point(x,y_new);
}
Point set_r(double r_new)
{
    return Point(r_new,y);
}
Point set_phi(double phi_new)
{
    return Point(x,phi_new);
}
};
